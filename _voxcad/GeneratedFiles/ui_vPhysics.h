...
public:
    ...
    QCheckBox *CoMCheck;
    QGroupBox *PlotForcesGroup;
    QHBoxLayout *horizontalLayout_140;
    QVBoxLayout *verticalLayout_90;
    QRadioButton *PlotDragRadio;
    QRadioButton *PlotSpeedsRadio;
    QRadioButton *PlotNormalsRadio;
    QVBoxLayout *verticalLayout_70;
    QCheckBox *PlotForcesCheck;
    QLineEdit *ForcesScalingEdit;
    ...
    void setupUi(QWidget *PhysicsDialog)
    {
        ...
        StiffnessRadio = new QRadioButton(ColorGroup);
        StiffnessRadio->setObjectName(QString::fromUtf8("StiffnessRadio"));

        verticalLayout_10->addWidget(StiffnessRadio);
        ...
        verticalLayout_10->addWidget(StrainERadio);
        ...
        verticalLayout_8->addWidget(KineticERadio);
        ...
        PlotForcesGroup = new QGroupBox(View);
        PlotForcesGroup->setObjectName(QString::fromUtf8("PlotForcesGroup"));
        horizontalLayout_140 = new QHBoxLayout(PlotForcesGroup);
        horizontalLayout_140->setSpacing(2);
        horizontalLayout_140->setObjectName(QString::fromUtf8("horizontalLayout_140"));
        horizontalLayout_140->setContentsMargins(-1, 3, -1, 3);
        verticalLayout_90 = new QVBoxLayout();
        verticalLayout_90->setObjectName(QString::fromUtf8("verticalLayout_90"));
        PlotDragRadio = new QRadioButton(PlotForcesGroup);
        PlotDragRadio->setObjectName(QString::fromUtf8("PlotDragRadio"));

        verticalLayout_90->addWidget(PlotDragRadio);

        PlotSpeedsRadio = new QRadioButton(PlotForcesGroup);
        PlotSpeedsRadio->setObjectName(QString::fromUtf8("PlotSpeedsRadio"));

        verticalLayout_90->addWidget(PlotSpeedsRadio);

        PlotNormalsRadio = new QRadioButton(PlotForcesGroup);
        PlotNormalsRadio->setObjectName(QString::fromUtf8("PlotNormalsRadio"));

        verticalLayout_90->addWidget(PlotNormalsRadio);


        horizontalLayout_140->addLayout(verticalLayout_90);

        verticalLayout_70 = new QVBoxLayout();
        verticalLayout_70->setObjectName(QString::fromUtf8("verticalLayout_70"));
        PlotForcesCheck = new QCheckBox(PlotForcesGroup);
        PlotForcesCheck->setObjectName(QString::fromUtf8("PlotForcesCheck"));

        verticalLayout_70->addWidget(PlotForcesCheck);


        horizontalLayout_140->addLayout(verticalLayout_70);

        ForcesScalingEdit = new QLineEdit(PlotForcesGroup);
        ForcesScalingEdit->setObjectName(QString::fromUtf8("ForcesScalingEdit"));
        ForcesScalingEdit->setEnabled(true);
        sizePolicy.setHeightForWidth(ForcesScalingEdit->sizePolicy().hasHeightForWidth());
        ForcesScalingEdit->setSizePolicy(sizePolicy);
        ForcesScalingEdit->setMinimumSize(QSize(41, 0));
        ForcesScalingEdit->setMaximumSize(QSize(41, 16777215));

        horizontalLayout_140->addWidget(ForcesScalingEdit);


        verticalLayout_11->addWidget(PlotForcesGroup);
        ...
        UseFloorSlopeCheck = new QCheckBox(Environment);
        UseFloorSlopeCheck->setObjectName(QString::fromUtf8("UseFloorSlopeCheck"));

        verticalLayout_5->addWidget(UseFloorSlopeCheck);
...
#ifndef QT_NO_TOOLTIP
        TypeRadio->setToolTip(QApplication::translate("PhysicsDialog", "Forward model", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        TypeRadio->setText(QApplication::translate("PhysicsDialog", "Voxel size", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        StateRadio->setToolTip(QApplication::translate("PhysicsDialog", "Phase offset", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        StateRadio->setText(QApplication::translate("PhysicsDialog", "Phase offset", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        StiffnessRadio->setToolTip(QApplication::translate("PhysicsDialog", "Voxel stiffness", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        StiffnessRadio->setText(QApplication::translate("PhysicsDialog", "Stiffness", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        DisplacementRadio->setToolTip(QApplication::translate("PhysicsDialog", "Forward model Predition", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        DisplacementRadio->setText(QApplication::translate("PhysicsDialog", "Pain", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        StrainERadio->setToolTip(QApplication::translate("PhysicsDialog", "Light intensity", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        StrainERadio->setText(QApplication::translate("PhysicsDialog", "Light intensity", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        KineticERadio->setToolTip(QApplication::translate("PhysicsDialog", "Voltage", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        KineticERadio->setText(QApplication::translate("PhysicsDialog", "Voltage", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
...
"Strain", 0, QApplication::UnicodeUTF8));
        ...
        PlotForcesGroup->setTitle(QApplication::translate("PhysicsDialog", "Plot forces", 0, QApplication::UnicodeUTF8));
        PlotDragRadio->setText(QApplication::translate("PhysicsDialog", "Drag forces", 0, QApplication::UnicodeUTF8));
        PlotSpeedsRadio->setText(QApplication::translate("PhysicsDialog", "Projected speeds", 0, QApplication::UnicodeUTF8));
        PlotNormalsRadio->setText(QApplication::translate("PhysicsDialog", "Surface normals", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        PlotForcesCheck->setToolTip(QApplication::translate("PhysicsDialog", "Plot forces?", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        PlotForcesCheck->setText(QApplication::translate("PhysicsDialog", "Plot forces?", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        ForcesScalingEdit->setToolTip(QApplication::translate("PhysicsDialog", "Scaling factor of plotted vectors", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        UseFloorSlopeCheck->setToolTip(QApplication::translate("PhysicsDialog", "Enables floor slope", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        UseFloorSlopeCheck->setText(QApplication::translate("PhysicsDialog", "Enable floor slope", 0, QApplication::UnicodeUTF8));
